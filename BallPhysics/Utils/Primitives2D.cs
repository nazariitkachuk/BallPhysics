// Code from https://github.com/z2oh/C3.MonoGame.Primitives2D
// Original code at: https://bitbucket.org/C3/2d-xna-primitives/wiki/Home
// Original License:
...
namespace C3.MonoGame
{
	...
	public static class Primitives2D
	{
        ...
        //Modified by pawelplodzpl to be able to rotate around center of the rectangle
        //rotationOffset = origin. (0.5f, 0.5f) is the middle of the rectangle (original texture is 1x1 pixel)
        public static void FillRectangle(this SpriteBatch spriteBatch, Rectangle rect, Color color, float angle, Vector2 origin)
        {
            if (pixel == null)
            {
                CreateThePixel(spriteBatch);
